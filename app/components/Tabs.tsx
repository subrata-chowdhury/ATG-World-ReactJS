    ...
    return (
        <div className='flex justify-between md:border-b border-[#E0E0E0] mt-[22px] ms-[16px] mr-[18px] mb-[26px] md:mt-[32px] md:mb-[28px] md:mx-[10%] xl:mx-[13.888%]'>
            ...
            <div className='flex gap-4 items-center ms-[20px]'>
                ...
                <div className='rounded-[4px] bg-[#EDEEF0] w-[133px] h-[36px] justify-center items-center gap-2.5 text-[#000] text-[15px] font-medium hidden md:flex'>Write a Post<Image src="/Icons/downArrow.svg" alt="" width={22} height={22} /></div>
