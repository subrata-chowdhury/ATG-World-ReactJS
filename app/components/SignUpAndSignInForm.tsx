                        ...
                        <div className='w-full md:w-auto'>
                            ...
                            <div className='w-full md:w-[320px]'>
                                {isInSignUpState && <div className='flex w-full'>
                                    <input type='text' className='h-[46px] rounded-tl-[2px] w-1/2 border-[1px] border-[#D9D9DB] bg-[#F7F8FA] py-[15px] px-[12px] placeholder:text-[#8A8A8A] text-[13px] md:text-[15px] font-medium leading-[16px] outline-0' placeholder='First Name' />
                                    <input type='text' className='h-[46px] rounded-tr-[2px] w-1/2 border-[1px] border-l-0 border-[#D9D9DB] bg-[#F7F8FA] py-[15px] px-[12px] placeholder:text-[#8A8A8A] text-[13px] md:text-[15px] font-medium leading-[16px] outline-0' placeholder='Last Name' />
                                </div>}
                                <input type='text' className={`h-[46px] border-[1px] border-[#D9D9DB] w-full bg-[#F7F8FA] py-[15px] px-[12px] placeholder:text-[#8A8A8A] text-[13px] md:text-[15px] font-medium leading-[16px] outline-0 ${isInSignUpState ? "border-t-0" : ''}`} placeholder='Email' />
                                <div className='h-[46px] border-[1px] border-t-0 border-[#D9D9DB] w-full bg-[#F7F8FA] flex justify-between pr-[18px]'>
                                    <input type='text' className='text-[13px] md:text-[15px] font-medium leading-[16px] placeholder:text-[#8A8A8A] py-[15px] px-[12px] outline-0' placeholder='Password' />
                                    <Image src={'/Icons/eye.svg'} width={18} height={18} alt='' />
                                </div>
                                {isInSignUpState && <input type='text' className='h-[46px] rounded-b-[2px] border-t-0 border-[1px] border-[#D9D9DB] w-full bg-[#F7F8FA] py-[15px] px-[12px] placeholder:text-[#8A8A8A] text-[13px] md:text-[15px] font-medium leading-[16px] outline-0' placeholder='Confirm Password' />}
                            </div>
                            <div className='flex justify-between items-center'>
                                <button className='text-[#FFF] text-center text-[13px] md:text-[14px] font-semibold leading-[16px] mt-[19px] mb-[24px] w-[150px] md:w-full flex justify-center items-center h-[40px] rounded-[20px] bg-[#2F6CE5]'>{isInSignUpState ? 'Create Account' : 'Sign In'}</button>
                            ...
                            <button className='flex gap-[10px] justify-center items-center rounded-[2px] border-[0.6px] border-[#D9D9DB] bg-[#FFF] w-full md:w-[320px] h-[38px] text-[#000] text-[13px] md:text-[14px] font-normal leading-[16px]'><Image src={'/images/facebook.png'} width={16} height={16} alt='' />Sign up with Facebook</button>
                            <button className='flex gap-[10px] justify-center items-center rounded-[2px] border-[0.6px] border-[#D9D9DB] bg-[#FFF] w-full md:w-[320px] h-[38px] mt-[8px] text-[#000] text-[13px] md:text-[14px] font-normal leading-[16px]'><Image src={'/Icons/google.svg'} width={16} height={16} alt='' />Sign up with Google</button>
                            {!isInSignUpState && <div className='text-[#000] text-center text-[12px] font-medium leading-[16px] mt-[23px] cursor-pointer'>Forgot Password?</div>}
